INSERT INTO shopping_cart_db1.USER (user_id, password, email, username, name, last_name, active)
VALUES
...
INSERT INTO shopping_cart_db1.ROLE (role_id, role)
VALUES (1, 'ROLE_ADMIN');
INSERT INTO shopping_cart_db1.ROLE (role_id, role)
VALUES (2, 'ROLE_USER');

INSERT INTO shopping_cart_db1.USER_ROLE (user_id, role_id)
VALUES (1, 1);
INSERT INTO shopping_cart_db1.USER_ROLE (user_id, role_id)
VALUES (1, 2);
INSERT INTO shopping_cart_db1.USER_ROLE (user_id, role_id)
...
INSERT INTO shopping_cart_db1.PRODUCT (name, description, quantity, price)
